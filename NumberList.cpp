...
void NumberList::displayList() const
{
   ...
   if (nodePtr == NULL)//if the value of first linked list is null, then it is all null
   {
	   cout << "The list is empty" << endl;//output if the linked list is empty
   }
   while (nodePtr)
   {
...
bool  NumberList::isMember(double num)
{
	bool isFound = false;
	ListNode *nodePtr = head;   // Start at head of list
	while (nodePtr)
	{
		// checks each value with users value
